...
def main():
    ...
    parser.add_argument('--dataset_root_dir', type=str, default='./dataset/train/')
    ...
    train_dataset = Dataset(dir_A=dir_A, dir_B=dir_B, in_channel=args.in_channel, pair_num=args.train_num)
